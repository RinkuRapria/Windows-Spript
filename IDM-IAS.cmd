...
cls
color 07
title  IDM Activation Script %Unknown%
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Created By Someone"
echo:            ___________________________________________________ 
echo:
echo:               Website: https://Rinkurapria.in.net
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
...
if %_erl%==6 exit /b
if %_erl%==5 start https://www.rinkurapria.in.net/2024/07/activate-idm-in-free-lifetime.html & goto MainMenu
